...
# - Load models
from model.perm_rfn_unet_x_v2 import PermutohedralRefinedUNetX
...
def main():
    ...
    with open(os.path.join(save_path, save_info_name), 'w') as fp:
        ...
        for test_name in test_names:
            ...
            print("Write to {}.".format(os.path.join(save_path, save_npz_name)))
            plt.imsave(os.path.join(save_path, save_png_name), refinement, cmap='gray')
            print("Write to {}".format(os.path.join(save_path, save_png_name)))
